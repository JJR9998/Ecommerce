    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-lg rounded-4 border border-0 p-4" style="background-color: #000;">
                <div class="card-header bg-black text-white text-center fs-3">{{ __('Register') }}</div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-12 mt-3 d-flex flex-column align-items-center">
                                ...
                                <a class="btn btn-link text-decoration-none mt-2 text-white" href="{{ route('login') }}">¿Ya tienes una cuenta? Inicia Sesión</a>
                            </div>
                        </div>
                    </form>
                </div>
